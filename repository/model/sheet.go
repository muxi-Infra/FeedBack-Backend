...
type FAQResolution struct {
	...
	UserID        *string `gorm:"column:user_id;not null;type:varchar(255);index:idx_user_id;uniqueIndex:uk_user_record"`
	TableIdentify *string `gorm:"column:table_identify;not null;type:varchar(255);uniqueIndex:uk_user_record"`
