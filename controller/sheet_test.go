...
func TestCreateAppTableRecord(t *testing.T) {
	...
	testCases := []testCase{
		...
		},
		{
			...
			setupMocks: func(mockSvc *ServiceMock.MockSheetService) {
				mockSvc.EXPECT().
					CreateRecord(gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any()).
					Return(nil, errors.New("service error"))
			},
			expectedCode:  500,
			expectedError: true,
...
func TestGetAppTableRecord(t *testing.T) {
	...
	testCases := []testCase{
		...
		},
		{
			...
			setupMocks: func(mockSvc *ServiceMock.MockSheetService) {
				mockSvc.EXPECT().
					GetRecord(gomock.Any(), gomock.Any(), gomock.Any()).
					Return(nil, errors.New("service error"))
			},
			expectedCode:  500,
			expectedError: true,
...
func TestGetNormalRecord(t *testing.T) {
	...
	testCases := []testCase{
		...
		},
		{
			...
			setupMocks: func(mockSvc *ServiceMock.MockSheetService) {
				mockSvc.EXPECT().
					GetNormalRecord(gomock.Any(), gomock.Any(), gomock.Any()).
					Return(nil, errors.New("service error")).
					AnyTimes()
			},
			expectedCode:  500,
	...
	testCases := []testCase{
		{
			...
			setupMocks: func(mockSvc *ServiceMock.MockSheetService) {
				mockSvc.EXPECT().
					GetPhotoUrl(gomock.Any(), gomock.Any()).
					Return(nil, errors.New("service error")).
					AnyTimes()
			},
			expectedCode:  500,
