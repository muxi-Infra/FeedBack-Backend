...
func InitApp() (*App, error) {
	...
	integrationNonceStore := cache.NewIntegrationNonceStore(client)
	authService := service.NewAuthService(clientConfig, loggerLogger, jwt, integrationAuthConfig, integrationDAO, projectConfigEventBus, integrationNonceStore)
